...
var $author$project$PhotoFolders$initialModel = {images: $elm$core$Dict$empty, selectedImageUrl: $elm$core$Maybe$Nothing};
...
var $author$project$PhotoFolders$modelDecoder = $elm$json$Json$Decode$succeed(
	{
		...
		selectedImageUrl: $elm$core$Maybe$Just('trevi')
	});
		...
		if (msg.$ === 'ClickedImage') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						selectedImageUrl: $elm$core$Maybe$Just(url)
					}),
...
var $author$project$PhotoFolders$ClickedImage = function (a) {
	return {$: 'ClickedImage', a: a};
};
...
var $author$project$PhotoFolders$viewRelatedImage = function (url) {
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
				...
				$author$project$PhotoFolders$ClickedImage(url)),
				$elm$html$Html$Attributes$src($author$project$PhotoFolders$urlPrefix + ('photos/' + (url + '/thumb')))
			]),
		_List_Nil);
};
var $author$project$PhotoFolders$viewSelectedImage = function (image) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src($author$project$PhotoFolders$urlPrefix + ('photos/' + (image.url + '/full')))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$span,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(image.size) + 'KB')
					])),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
				...
				A2($elm$core$List$map, $author$project$PhotoFolders$viewRelatedImage, image.relatedUrls))
			]));
};
var $author$project$PhotoFolders$view = function (model) {
	var imageByUrl = function (url) {
		return A2($elm$core$Dict$get, url, model.images);
	};
	var selectedImage = function () {
		var _v0 = A2($elm$core$Maybe$andThen, imageByUrl, model.selectedImageUrl);
		if (_v0.$ === 'Just') {
			var image = _v0.a;
			return $author$project$PhotoFolders$viewSelectedImage(image);
		} else {
